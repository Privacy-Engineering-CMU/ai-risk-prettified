...
<head>
    ...
    <title>AI Risk Database Prettified</title>
    <style>
        body {
...
<body>
    <div id="page-container">
        <h1>AI Risk Database Prettified</h1>
        <div class="intro">
            <p><strong>What is the AI Risk Database?</strong><br>
            The <strong>AI Risk Database</strong> captures 700+ risks extracted from 43 existing frameworks, with quotes and page numbers.
            <div class="disclaimer">
                <p>This is not a work done by CMU students but rather by MIT. Please support and check out the actual database: <a href="https://airisk.mit.edu/" target="_blank">https://airisk.mit.edu/</a></p>
